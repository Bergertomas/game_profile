...
1. `docs/Game_Profile_Master_Product_and_Build_Plan_v0.7.md`
...
Do not use older Master Plans or Project Context files as current authority where v0.7 supersedes them. Preserve historical documents unless explicitly directed otherwise.
