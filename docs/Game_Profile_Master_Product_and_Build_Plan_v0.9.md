...
8. Implement the accepted homepage/profile composition in bounded vertical
   ...
   time. **HOMEPAGE DONE ON `main` (Slice 2); PROFILE DONE ON THE SLICE 3
   INTEGRATION BRANCH — pending review, merge and deliberate deployment.
