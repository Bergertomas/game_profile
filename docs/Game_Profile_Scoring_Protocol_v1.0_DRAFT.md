...
The owner-approved methodological direction is recorded in
`Should_I_Play_Public_Product_P0_Decisions_2026-08-24.md`. This candidate is the
detailed provisional contract that attempts to implement that direction; it
does not become governing merely because it is present in the repository.
