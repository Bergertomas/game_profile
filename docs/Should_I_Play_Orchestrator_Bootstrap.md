...
- **Recovery observation, 5 September 2026:** automation `6a9a57402f248191857fc31c2cd46baf` is currently the bounded `Should I Play — Night Run`, disabled after its final 06:01 UTC run; no standing hourly recovery task is armed. Event Wake is enabled, but the post-#106/#107 current-prompt requalification remains pending. #115 supplies the qualification/decision packet; #113 coordinates owner decisions. Do not treat the historical primary promotion as current qualification or silently change schedules.
