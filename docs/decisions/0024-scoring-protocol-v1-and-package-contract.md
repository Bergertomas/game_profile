...
§18; Evidence SOP v0.2 §3, §5; ADRs 0005, 0006, 0009; Master Plan v0.9
§0.3–0.4 and §3.5–3.7; the dated Public Product P0 Decision Set; the repository
review of `25b85fe`.
...
Master Plan v0.9 Phase 3A is the durable cross-project tracker for these gates.
...
- Final governing approval of Protocol v1.0 approves this register; a rejected
  ...
  dropped.
- On final governing approval: SOP v0.2 → v0.3 (source-target vocabulary,
  confidence facts),
