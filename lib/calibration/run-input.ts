...
export const D1_RUN_INPUT: Phase3ADevelopmentRunInput = Object.freeze({
  ...
  scope: Object.freeze({
    ...
    build_cutoff: "Current patched standard first-playthrough base main campaign at the D1 evidence cutoff, including free Anniversary/QoL updates applicable to that campaign; The Final Draft / New Game Plus is a separate replay scope and is excluded.",
    ...
    known_exclusions: Object.freeze(["The Final Draft / New Game Plus", "Night Springs", "The Lake House"]),
