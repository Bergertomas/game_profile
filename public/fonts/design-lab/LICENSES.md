...
All five files were obtained from the Google Fonts CSS API
...
These faces are used **only** by the development-only `/design-lab` routes and
are loaded solely by `app/design-lab/design-lab.css`. No production page
references them.
...
|---|---|---|---|---|
| `archivo.woff2` | Archivo | 2.001 | `wght` 100–900, `wdth` 62–125 | 302 |
| `newsreader.woff2` | Newsreader | 1.003 | `wght` 200–800, `opsz` 6–72 | 262 |
